...
class ActivityOverviewBloc {
  ...
  final _stateStreamController = StreamController<VendorActivtyOverviewResponse>();
  StreamSink<VendorActivtyOverviewResponse> get _activtyOverviewSink => _stateStreamController.sink;
  Stream<VendorActivtyOverviewResponse> get activtyOverviewStream => _stateStreamController.stream;

  //user input event StreamController
  final _eventStreamController = StreamController<ActivityOverviewAction>();
  StreamSink<ActivityOverviewAction> get eventSink => _eventStreamController.sink;
  Stream<ActivityOverviewAction> get _eventStream => _eventStreamController.stream;
  ...
  getUpdatedActivityOverviewList(VendorActivtyOverviewResponse vendorActivityOverviewResponse){
