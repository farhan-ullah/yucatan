...
class RegisterValidationBloc{
  ...
  StreamSink<RegisterValidationAction> get eventSink => _eventStreamController.sink;
  Stream<RegisterValidationAction> get _eventStream => _eventStreamController.stream;
  ...
  bool isRegisterSubmitButtonPressed;
