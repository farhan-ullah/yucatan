import 'package:appventure/screens/authentication/components/input_checkbox_rich.dart';
...
class RegisterPolicy extends StatefulWidget {
  ...
  const RegisterPolicy({Key key, this.onChange,this.registerValidationBloc}) : super(key: key);
              ...
              TextSpan(
                ...
                recognizer: TapGestureRecognizer()
                 ..onTap = () {
                   Navigator.push(
                     context,
                     MaterialPageRoute(builder: (context) => ImpressumDatenschutz(
